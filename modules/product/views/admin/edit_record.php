										...
										<div id="lang_<?php echo $item->lang ?>" class="tab-pane fade <?php echo($item->default == 1)?"active in":""; ?>" role="tabpanel">
											<div class="row">											
												<div class="col-md-9 col-xs-12">
														...
														<div class="col-md-3 col-xs-12">
															<div class="form-group">
																...
																<select class="form-control" id="<?php echo $item->lang ?>[page_type]" name="<?php echo $item->lang ?>[page_type]" <?php echo($item->default == 1)?'required="required"':""; ?>>
																	...
																	<option value="category" <?php echo(@$page[$item->lang]['page_type'] == "category")?"selected":""; ?>>Kategori</option>
																	<option value="product" <?php echo(@$page[$item->lang]['page_type'] == "product")?"selected":""; ?>>Ürün</option>
																</select>
															</div>		
														</div>
													</div>
													...
													<hr />
													<?php if(@$page[$item->lang]["extra"]){ $page[$item->lang]["extra"] = json_decode($page[$item->lang]["extra"]); }else{ $page[$item->lang]["extra"] = json_decode('[{"i0":"","i1":"","i2":"","i3":""}]'); } ?>
															...
															<div class="col-md-11 col-xs-12">
																<div class="row">
																	<div class="col-md-3 col-xs-6">
																		<input type="text" class="form-control" name="<?php echo $item->lang ?>[extra][<?php echo $i ?>][i0]" placeholder="Ölçü" value="<?php echo @$extraValue->i0 ?>" />
																	</div>
																	<div class="col-md-3 col-xs-6">
																		<input type="text" class="form-control" name="<?php echo $item->lang ?>[extra][<?php echo $i ?>][i1]" placeholder="Peşin Fiyatı" value="<?php echo @$extraValue->i1 ?>" />
																	</div>
																	<div class="col-md-3 col-xs-6">
																		<input type="text" class="form-control" name="<?php echo $item->lang ?>[extra][<?php echo $i ?>][i2]" placeholder="İndirimli Fiyatı" value="<?php echo @$extraValue->i2 ?>" />
																	</div>
																	<div class="col-md-3 col-xs-6">
																		<input type="text" class="form-control" name="<?php echo $item->lang ?>[extra][<?php echo $i ?>][i3]" placeholder="Taksit Fiyatı" value="<?php echo @$extraValue->i3 ?>" />
																	</div>
																</div>
															</div>
