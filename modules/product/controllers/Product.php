	...
	public function index()
	{
		...
		if(!empty ($this->data['page'])){
			...
			if (!$this->data['page']['gallery_images']) {
				$this->data['page']['gallery_images'] = $this->Product_model->gallery_images(get_lang_id_record($this->data['page']['id'], "product", $this->data["default_lang"]->lang)->id);
			}
			...
			if (file_exists('modules/product/views/group/id'.$default_lang_record->id.'.php') == true){
				$this->load->view('product/group/id'.$default_lang_record->id, $this->data);
