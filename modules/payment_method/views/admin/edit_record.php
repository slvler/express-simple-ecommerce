										...
										<div class="row">											
											<div class="col-md-9 col-xs-12">
												<div class="form-group">
													<label class="control-label mb-10 text-left" for="title">Ödeme Methodu Adı</label>
													<input type="text" class="form-control" id="title" name="title" placeholder="Ödeme Methodu Adı" required="required" value="<?php echo $page["title"]; ?>" />
												</div>
											</div>					
